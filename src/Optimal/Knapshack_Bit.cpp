...
vector<vector<int>> bitKnapshack(const vector<int>& weights, const vector<int>& values) {
...
void knapsack(const vector<int>& weights, const vector<int>& values) {
    vector<vector<int>> DP = bitKnapshack(weights, values);
    printDP(DP);
